namespace primeraprueba
{
	partial class Contrasenya
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlIniciar.Controls.Add(this.lblConfirmar);
			this.pnlIniciar.Controls.Add(this.txtCorreo);
			this.pnlIniciar.Controls.Add(this.lblContraseña);
			this.pnlIniciar.Controls.Add(this.btConfirmar);
			this.pnlIniciar.Controls.Add(this.lblCorreo);
			this.pnlIniciar.Controls.Add(this.txtConfirmar);
			...
			this.pnlIniciar.Location = new System.Drawing.Point(283, 137);
